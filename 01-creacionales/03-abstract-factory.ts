...
class ChickenHamburger implements Hamburger {
  prepare(): void {
    console.log("Preparando hamgurgesa de %cPollo", COLORS.yellow);
  }
}

class BeefHamburger implements Hamburger {
  prepare(): void {
    console.log("Preparando hamgurgesa de %cRes", COLORS.red);
  }
}
...
class Soda implements Drink {
  pour(): void {
    console.log("Sirviendo un vaso de %cgaseosa", COLORS.green);
  }
}
