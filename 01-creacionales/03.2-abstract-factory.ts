...
class ElectricCar implements Vehicle {
  assemble(): void {
    console.log("%cEnsamblando el vehiculo electrico", COLORS.blue);
  }
}

class GasCar implements Vehicle {
  assemble(): void {
    console.log("%cEnsamblando el vehiculo combustión", COLORS.brown);
  }
}
...
class GasEngine implements Engine {
  start(): void {
    console.log("%cArrancando motor combustión", COLORS.brown);
  }
}
